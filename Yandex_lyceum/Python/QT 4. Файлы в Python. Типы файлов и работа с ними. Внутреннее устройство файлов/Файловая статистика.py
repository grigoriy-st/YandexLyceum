        ...
        if os.path.isfile('./' + file_name):
            ...
            if file_strings:
                try:
                    ...
                    out.write(f'Максимальное значение = {self.minEdit.text()}\n')
                    out.write(f'Минимальное значение = {self.maxEdit.text()}\n')
                    out.write(f'Среднее значение = {avg_num}\n')

                    out.close()
                except ValueError:
                    self.clear_fields('Файл содержит некорректные данные')

            else:
                self.clear_fields("Указанный файл пуст")

        else:

            self.clear_fields("Указанный файл не существует")

    def clear_fields(self, msg=None):
