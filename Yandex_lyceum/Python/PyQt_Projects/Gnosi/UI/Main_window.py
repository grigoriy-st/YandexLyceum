...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.change_name = QtWidgets.QPushButton(parent=self.tab_image_account)
        self.change_name.setObjectName("change_name")
        self.horizontalLayout_10.addWidget(self.change_name)
        ...
        self.change_name.clicked.connect(self.printik)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.change_name.setText(_translate("MainWindow", "Изменить"))
