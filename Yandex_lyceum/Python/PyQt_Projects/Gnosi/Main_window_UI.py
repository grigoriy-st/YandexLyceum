...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        if self.LE_profile_type.text() == 'Преподаватель':
            print("WORK")
            ...
            self.pbt_move_uo = QtWidgets.QPushButton(parent=self.tab_create_cource)
            sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
            sizePolicy.setHorizontalStretch(0)
            sizePolicy.setVerticalStretch(0)
            sizePolicy.setHeightForWidth(self.pbt_move_uo.sizePolicy().hasHeightForWidth())
            self.pbt_move_uo.setSizePolicy(sizePolicy)
            self.pbt_move_uo.setObjectName("pbt_move_uo")
            self.horizontalLayout_8.addWidget(self.pbt_move_uo)
    ...
    def retranslateUi(self, MainWindow):
        ...
        if self.LE_profile_type.text() == 'Преподаватель':
            ...
            self.pbt_move_uo.setText(_translate("MainWindow", "Переместить выше"))
